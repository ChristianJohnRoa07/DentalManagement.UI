...
import { TREATMENT_CHIP, APPOINTMENTS } from "../../../common/constants";

function ReservePatients({ appointments }: AppointmentProps) {
    ...
    return (
        ...
        <Paper elevation={0} sx={{ border: "1px solid #F3F4F6", borderRadius: 3 }}>
            <Stack direction="row" justifyContent="space-between" alignItems="center"
                ...
                <Typography sx={{ fontSize: "0.875rem", fontWeight: 600 }}>For Appointments Confirmation</Typography>
...
export default ReservePatients;